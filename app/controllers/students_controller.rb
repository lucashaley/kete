class StudentsController < ApplicationController
  before_action :set_student, only: [:show, :edit, :update, :destroy, :createPDP]
  ...
  private
    ...
    def student_params
      params.require(:student).permit(:first_name, :last_name, :massey_identification, :email, :preferred_name, :image)
    end
end
