class ComputersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @computer.save
        @computer.update_column(:id, computer_params[:its_code])
  ...
  private
    ...
    def computer_params
      params.require(:computer).permit(:model, :operating_system, :date_of_purchase, :lab, :software_packages_id, :its_code)
    end
end
