class OfferingsController < ApplicationController
  before_action :set_offering, only: [:show, :edit, :update, :destroy, :add_student]
  ...
  private
    ...
    def offering_params
      params.require(:offering).permit(:semester_id, :course_id, :instructor_id, :facebook_group, enrolments_attributes: [:id, :massey_identification])
    end
end
